...
from vpg07.tools_external import DOG_IMAGE_URL_LINE_PREFIX
...
@patch("vpg07.haystack_assistant.build_external_tools", return_value=[])
@patch("vpg07.haystack_assistant.Agent")
@patch("vpg07.haystack_assistant.OpenAIChatGenerator")
@patch("vpg07.haystack_assistant.WeaviateEmbeddingRetriever")
@patch("vpg07.haystack_assistant.OpenAIDocumentEmbedder")
@patch("vpg07.haystack_assistant.OpenAITextEmbedder")
@patch("vpg07.haystack_assistant.WeaviateDocumentStore")
